    ...
    <div className="h-screen bg-[var(--bg)] text-slate-900">
      <div className="flex h-screen w-full overflow-hidden shadow-[0_24px_80px_rgba(8,61,82,0.10)]">
        ...
        <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
          ...
          >
            <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
              <div className="flex items-center gap-4">
                <div className="flex h-12 w-12 items-center justify-center border border-white/16 bg-white/12 lg:hidden">
                  <Droplets className="h-6 w-6 text-white" />
                </div>
                <div>
                  <p className="text-[10px] font-semibold uppercase tracking-[0.32em] text-white/58">
                    Active Module
                  </p>
                  <div className="mt-1 flex flex-wrap items-center gap-3">
                    ...
                    <span className="inline-flex items-center gap-2 border border-white/14 bg-white/10 px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-white/74">
              ...
              <label className="flex min-w-0 flex-1 items-center gap-3 border border-white/14 bg-white/12 px-4 py-3 text-white/78 backdrop-blur-md xl:max-w-[640px]">
          ...
          <div className="border-b border-slate-200/70 bg-white/72 px-4 py-3 backdrop-blur-md lg:hidden">
          ...
          <main className="scrollbar-hidden min-h-0 flex-1 overflow-y-auto bg-[linear-gradient(180deg,rgba(246,251,254,0.96),rgba(236,245,250,0.94))] px-4 py-5 sm:px-6 lg:px-8">
            <Outlet />
          </main>
        </div>
      </div>
